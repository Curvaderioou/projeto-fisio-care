...
// Mudar Aqui o e-mail
$email_envio = "atendimento@fisiocare.site"; // E-mail do site (ex: contato@seusite.com)
$email_pass = "fisiocare2021"; // Senha do e-mail

$site_name = "FisioCare"; // Nome do Site
$site_url = "www.fisiocare.site"; // URL do Site

$host_smtp = "mail.fisiocare.site"; // HOST SMTP Ex: smtp.domain.com.br
